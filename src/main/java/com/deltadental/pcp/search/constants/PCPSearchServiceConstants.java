package com.deltadental.pcp.search.constants;
...
public class PCPSearchServiceConstants {
	 ...
	 * private constructor.
	 */
	private PCPSearchServiceConstants() {
	...
	public static final String SUMMARY_STATE_PCP_ASSIGNMENT = "State PCP assignment";
	...
	public static final String SUMMARY_PCPVALIDATE = "Primary Care Provider(PCP) Validation";
	...
	public static final String SUMMARY_BUSINESS_LEVELS_NOTES = "This API retrives all the Business Levels for the Business Levels request.";
	public static final String SUMMARY_BP_AND_BUSINESS_LEVELS_NOTES = "This API retrives all the Benefit Package and Business Levels.";
	public static final String SUMMARY_STATE_PCP_ASSIGNMENT_NOTES = "This API retrives all the State PCP assignments";
	...
	public static final String SUMMARY_SUMMARY_PCPVALIDATE_NOTES = "This API validates the Primary Care Provider(PCP)";
	...
	public static final String GET_PCPVALIDATE_URI = "/pcp-validate";
