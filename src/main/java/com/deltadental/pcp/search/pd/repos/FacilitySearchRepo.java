...
public interface FacilitySearchRepo extends JpaRepository<FacilitySearchEntity, Integer>{
	...
	final static String FACILITY_SEARCH_QUERY = "SELECT DISTINCT "
			...
			+ "            nvl(a.rendering_address1,'') address_line1, "
			+ "            nvl(a.rendering_address2,'') address_line2, "
			+ "            nvl(a.rendering_address3,'') address_line3, "
			+ "            a.rendering_city city, "
			+ "            a.rendering_state state, "
			+ "            a.rendering_zip zip, "
